...
describe('UniswapV2Pair', () => {
  ...
  const swapTestCases: BigNumber[][] = [
    [1, 5, 10, '1664582812369759106'],
    [1, 10, 5, '453925535300268218'],

    [2, 5, 10, '2854080320137201657'],
    [2, 10, 5, '832291406184879553'],

    [1, 10, 10, '907851070600536436'],
    [1, 100, 100, '988628543988277053'],
    [1, 1000, 1000, '997503992263724670']
  ...
  const optimisticTestCases: BigNumber[][] = [
    ...
    [1, 5, 5, '1001502253380070106'] // given amountOut, amountIn = ceiling(amountOut / .9985) - Not quite...
  ].map(a => a.map(n => (typeof n === 'string' ? bigNumberify(n) : expandTo18Decimals(n))))
  optimisticTestCases.forEach((optimisticTestCase, i) => {
    it(`optimistic:${i}`, async () => {
      ...
      await expect(pair.swap(outputAmount.add(1), 0, wallet.address, '0x', overrides)).to.be.revertedWith('Celswap: K')
